...
window.SerializerOracle.PackedJSONV3 = window.SerializerOracle.PackedJSONV3 || {};
...
"arpeggiator","stack", "multi_instrument"];
...
SerializerOracle.PackedJSONV3.serialize = function(type, obj) {
  if (packer[type]) {
